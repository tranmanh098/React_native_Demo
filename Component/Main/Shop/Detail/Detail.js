...
const back = require('../../../../Image/media/icons/back.png');
const cart = require('../../../../Image/media/icons/cartfull.png');
...
export default class Detail extends Component {
  ...
  addThisProductToCart(product) {
    ...
    //console.log(product);
    Alert.alert("Thêm sản phầm thành công !");
  }
  render() {
    const {
      ...
      <View style={wrapper}>
        <View style={cardStyle}>
          <View style={header}>
            ...
            <TouchableOpacity onPress={() => this.addThisProductToCart(route.params)}>
